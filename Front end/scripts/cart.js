...
let data = JSON.parse(localStorage.getItem('SmartStockers_cart'));
console.log(data);
...
function showProduct(data){
    if ( data.length == 0){
        ...
        btnFund.onclick = () => {
         window.location.href = `../Front end/SmartStockers_products.html`;   //./Front end/groww_home.html
        }  // http://127.0.0.1:5500/Front%20end/SmartStockers_products.html
...
function appendbtn(){
    ...
    btnFund.onclick = () => {
     window.location.href = `../Front end/SmartStockers_products.html`;
    }
...
function payment_page(){
    ...
    pay.onclick = () => {
        ...
        window.location.href = '../Front end/SmartStockers_payment.html';
    }
